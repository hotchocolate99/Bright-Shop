...
<header>
    ...
    <div class="h_container">
            ...
            <?php if(!empty($_SESSION['mgr'])):?>
                ...
                <ul>
                    <li><a href="/manage/products_list.php" class="link_a"><span>Products List</span></a></li>
                    <li><a href="/manage/add_product.php" class="link_a"><span>Add Product</span></a></li>
                </ul>
                </li>
                  <?php endif;?>
                  <li class="adj"><a href="/manage/orders_list.php" class="link_a"><span>Orders</span></a></li>
                  <li class="adj"><a href="/manage/users_list.php" class="link_a"><span>Users List</span></a></li>
                ...
                <?php else:?>
                  ...
                  <ul>
                     ...
                     <li><a href="/manage/mng_signup.php" class="link_a"><span><i class="fas fa-user"></i>Account</span></a></li>
                </ul>
                    </li>
                <?php endif;?>
              </ul>
